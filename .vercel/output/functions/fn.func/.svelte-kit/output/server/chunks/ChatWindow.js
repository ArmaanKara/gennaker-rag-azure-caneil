...
import { G as Gear_fill } from "./gear-fill.js";
...
const Send_alt_filled = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<svg${spread(
    ...
    {}
  )}><!-- HTML_TAG_START -->${`<path fill="currentColor" d="M27.71 4.29a1 1 0 0 0-1.05-.23l-22 8a1 1 0 0 0 0 1.87l8.59 3.43L19.59 11L21 12.41l-6.37 6.37l3.44 8.59A1 1 0 0 0 19 28a1 1 0 0 0 .92-.66l8-22a1 1 0 0 0-.21-1.05"/>`}<!-- HTML_TAG_END --></svg>`;
});
const Export = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<svg${spread(
    ...
    {}
  )}><!-- HTML_TAG_START -->${`<path fill="currentColor" d="M26 24v4H6v-4H4v4l.008-.005A1.998 1.998 0 0 0 6 30h20a2 2 0 0 0 2-2v-4zM6 12l1.411 1.405L15 5.825V24h2V5.825l7.591 7.58L26 12L16 2z"/>`}<!-- HTML_TAG_END --></svg>`;
});
const Stop_filled_alt = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<svg${spread(
    ...
    {}
  )}><!-- HTML_TAG_START -->${`<path fill="currentColor" d="M24 6H8a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2"/>`}<!-- HTML_TAG_END --></svg>`;
});
...
const Information = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<svg${spread(
    ...
    {}
  )}><!-- HTML_TAG_START -->${`<path fill="currentColor" d="M17 22v-8h-4v2h2v6h-3v2h8v-2zM16 8a1.5 1.5 0 1 0 1.5 1.5A1.5 1.5 0 0 0 16 8"/><path fill="currentColor" d="M16 30a14 14 0 1 1 14-14a14 14 0 0 1-14 14m0-26a12 12 0 1 0 12 12A12 12 0 0 0 16 4"/>`}<!-- HTML_TAG_END --></svg>`;
});
...
const Continue = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<svg${spread(
    ...
    {}
  )}><!-- HTML_TAG_START -->${`<path fill="currentColor" d="M10 28a1 1 0 0 1-1-1V5a1 1 0 0 1 1.501-.865l19 11a1 1 0 0 1 0 1.73l-19 11A.998.998 0 0 1 10 28m1-21.266v18.532L27 16zM4 4h2v24H4z"/>`}<!-- HTML_TAG_END --></svg>`;
});
...
const Download = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<svg${spread(
    ...
    {}
  )}><!-- HTML_TAG_START -->${`<path fill="currentColor" d="M26 24v4H6v-4H4v4a2 2 0 0 0 2 2h20a2 2 0 0 0 2-2v-4zm0-10l-1.41-1.41L17 20.17V2h-2v18.17l-7.59-7.58L6 14l10 10z"/>`}<!-- HTML_TAG_END --></svg>`;
});
const Thumbs_up = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<svg${spread(
    ...
    {}
  )}><!-- HTML_TAG_START -->${`<path fill="currentColor" d="M26 12h-6V6a3.003 3.003 0 0 0-3-3h-2.133a2.01 2.01 0 0 0-1.98 1.717l-.845 5.917L8.465 16H2v14h21a7.008 7.008 0 0 0 7-7v-7a4.005 4.005 0 0 0-4-4M8 28H4V18h4Zm20-5a5.006 5.006 0 0 1-5 5H10V17.303l3.958-5.937l.91-6.366H17a1 1 0 0 1 1 1v8h8a2.003 2.003 0 0 1 2 2Z"/>`}<!-- HTML_TAG_END --></svg>`;
});
...
const Error_filled = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<svg${spread(
    ...
    {}
  )}><!-- HTML_TAG_START -->${`<path fill="none" d="M9 10.555L10.555 9L23 21.444L21.444 23z"/><path fill="currentColor" d="M16 2A13.914 13.914 0 0 0 2 16a13.914 13.914 0 0 0 14 14a13.914 13.914 0 0 0 14-14A13.914 13.914 0 0 0 16 2m5.445 21L9 10.556L10.556 9L23 21.445Z"/>`}<!-- HTML_TAG_END --></svg>`;
});
...
const OpenWebSearchResults = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$result.css.add(css);
  sources = (_a = webSearchMessages.find((m) => m.sources)) === null || _a === void 0 ? void 0 : _a.sources;
...
const ChatMessage = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  function sanitizeMd(md) {
    ...
    for (const stop of [
      ...(_b2 = (_a2 = model.parameters) === null || _a2 === void 0 ? void 0 : _a2.stop) !== null && _b2 !== void 0 ? _b2 : [],
      "<|endoftext|>"
    ]) {
  ...
  message = (_a = messages.find((m) => m.id === id)) !== null && _a !== void 0 ? _a : {};
  tokens = marked.lexer(sanitizeMd(message.content));
  searchUpdates = (_c = (_b = message.updates) === null || _b === void 0 ? void 0 : _b.filter(({ type }) => type === "webSearch")) !== null && _c !== void 0 ? _c : [];
  ...
  webSearchSources = searchUpdates && ((_e = (_d = searchUpdates === null || searchUpdates === void 0 ? void 0 : searchUpdates.filter(({ messageType }) => messageType === "sources")) === null || _d === void 0 ? void 0 : _d[0]) === null || _e === void 0 ? void 0 : _e.sources);
  {
    if (((_k = message.children) === null || _k === void 0 ? void 0 : _k.length) === 0)
  ...
  (_g = message && ((_f = message.children) === null || _f === void 0 ? void 0 : _f.length) === 0) !== null && _g !== void 0 ? _g : false;
  childrenToRender = 0;
  nChildren = (_j = (_h = message === null || message === void 0 ? void 0 : message.children) === null || _h === void 0 ? void 0 : _h.length) !== null && _j !== void 0 ? _j : 0;
  {
    {
      if (initialized) {
  ...
  })}</div>` : ``} <div class="flex w-full flex-row flex-nowrap">${!editMode ? `<p class="disabled w-full appearance-none whitespace-break-spaces text-wrap break-words bg-inherit px-5 py-3.5 text-gray-500 dark:text-gray-400">  ${escape(message.content.split(" Context:")[0].trim())}</p>` : `<form class="flex w-full flex-col"${add_attribute("this", editFormEl, 0)}><textarea class="w-full whitespace-break-spaces break-words rounded-lg bg-gray-100 px-5 py-3.5 text-gray-500 *:h-max dark:bg-gray-800 dark:text-gray-400" required${add_attribute("this", editContentEl, 0)}>${escape(message.content.trim(), false)}</textarea> <div class="flex w-full flex-row flex-nowrap items-center justify-center gap-2 pt-2"><button type="submit" class="${"btn rounded-lg px-3 py-1.5 text-sm " + escape(
...
const ScrollToBottomBtn = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  function destroy() {
    ...
    scrollNode === null || scrollNode === void 0 ? void 0 : scrollNode.removeEventListener("scroll", updateVisibility);
  }
  onDestroy(destroy);
...
const ChatWindow = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    lastMessage = browser;
    lastIsError = lastMessage && !loading && (lastMessage.from === "user" || ((_a = lastMessage.updates) === null || _a === void 0 ? void 0 : _a.findIndex((u) => u.type === "status" && u.status === "error")) !== -1);
