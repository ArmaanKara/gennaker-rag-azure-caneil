...
function getError(field, returnForm) {
  var _a, _b;
  return (_b = (_a = returnForm === null || returnForm === void 0 ? void 0 : returnForm.errors.find((error) => error.field === field)) === null || _a === void 0 ? void 0 : _a.message) !== null && _b !== void 0 ? _b : "";
}
const AssistantSettings = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  let inputMessage1 = (_a = assistant === null || assistant === void 0 ? void 0 : assistant.exampleInputs[0]) !== null && _a !== void 0 ? _a : "";
  let inputMessage2 = (_b = assistant === null || assistant === void 0 ? void 0 : assistant.exampleInputs[1]) !== null && _b !== void 0 ? _b : "";
  let inputMessage3 = (_c = assistant === null || assistant === void 0 ? void 0 : assistant.exampleInputs[2]) !== null && _c !== void 0 ? _c : "";
  let inputMessage4 = (_d = assistant === null || assistant === void 0 ? void 0 : assistant.exampleInputs[3]) !== null && _d !== void 0 ? _d : "";
