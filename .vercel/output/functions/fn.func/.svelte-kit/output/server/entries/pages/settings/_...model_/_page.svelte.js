import { c as create_ssr_component, f as subscribe, i as set_store_value, e as escape, a as add_attribute, v as validate_component } from "../../../../chunks/ssr.js";
    ...
    if ($settings.customPrompts[$page.params.model] === void 0) {
      set_store_value(
        ...
        $settings.customPrompts = {
          ...$settings.customPrompts,
          [$page.params.model]: ((_a = $page.data.models.find((el) => el.id === $page.params.model)) === null || _a === void 0 ? void 0 : _a.preprompt) || ""
        },
        $settings
      );
    }
  }
  hasCustomPreprompt = $settings.customPrompts[$page.params.model] !== ((_b = $page.data.models.find((el) => el.id === $page.params.model)) === null || _b === void 0 ? void 0 : _b.preprompt);
