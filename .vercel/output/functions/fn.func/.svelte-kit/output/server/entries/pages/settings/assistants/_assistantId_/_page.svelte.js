import { c as create_ssr_component, b as spread, d as escape_object, f as subscribe, a as add_attribute, e as escape, v as validate_component } from "../../../../../chunks/ssr.js";
import "devalue";
...
const Copy_file = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<svg${spread(
    ...
    {}
  )}><!-- HTML_TAG_START -->${`<path fill="currentColor" d="m27.4 14.7l-6.1-6.1C21 8.2 20.5 8 20 8h-8c-1.1 0-2 .9-2 2v18c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V16.1c0-.5-.2-1-.6-1.4M20 10l5.9 6H20zm-8 18V10h6v6c0 1.1.9 2 2 2h6v10z"/><path fill="currentColor" d="M6 18H4V4c0-1.1.9-2 2-2h14v2H6z"/>`}<!-- HTML_TAG_END --></svg>`;
});
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  shareUrl = `${prefix}/assistant/${assistant === null || assistant === void 0 ? void 0 : assistant._id}`;
  $$unsubscribe_page();
