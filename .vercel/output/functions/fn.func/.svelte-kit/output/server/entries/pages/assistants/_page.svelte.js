...
const Pagination = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  pageIndex = parseInt((_a = $page.url.searchParams.get("p")) !== null && _a !== void 0 ? _a : "0");
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  createdByMe = ((_a = data.user) === null || _a === void 0 ? void 0 : _a.username) && data.user.username === assistantsCreator;
  $$unsubscribe_page();
